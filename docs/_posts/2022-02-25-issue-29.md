...
*  Added HIP support for linking archive of bundled bitcode. Such archive files can be linked with HIP programs with `-fgpu-rdc`. [D120070](https://reviews.llvm.org/D120070)
