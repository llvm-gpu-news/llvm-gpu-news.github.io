...
*  CUDA support for the `--ofload` parameter to override the default device target was added. This is meant for SPIR-V targets. [D117137](https://reviews.llvm.org/D117137)
