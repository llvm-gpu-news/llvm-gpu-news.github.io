...
*  Weiwei [expressed interests in contributing to SPIR-V dialect for graphics usage](https://llvm.discourse.group/t/glsl-operation-support-in-spirv-dialect/2655) and started sending out patches for it.
