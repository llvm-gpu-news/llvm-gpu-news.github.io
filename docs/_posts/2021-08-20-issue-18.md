...
*  Rematerialization of virtual register uses is not allowed. The change affected AMDGPU, ARM/Thumb, Mips, RISCV, and x86. [D106408](https://reviews.llvm.org/D106408)
